...
const Dropdown = (): JSX.Element => (
  <div className='relative inline-block text-sm'>
    ...
    <div
      className='absolute right-0 mt-2 w-56 rounded shadow-lg divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700'
      role='menu'
